Instagram ➜instagram.com/thefilmydj_/
YouTube ➜youtube.com/@thefilmydj
...
<body>
  <div class="wrap">
    ...
    <main class="hero">
      <div class="intro">
        <div class="eyebrow">Filmmaker • Storyteller • सखा धुरला</div>
        <div class="headline">कथा रंगवणारा — visuals आणि भावना दोन्ही देणारा.</div>
        <div class="lead">मी thefilmydj_ — कथा, भावना आणि visuals यांचं मिश्रण. माझं काम म्हणजे छोट्या गोष्टींना cinematic रूप देणं. Camera हातात आला की जग रंगात बदलतं — आणि तिथून सुरू होते एक नवी frame-by-frame सफर.</div>
        ...
        <section id="projects">
          ...
          <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:12px;margin-top:10px">
            <div class="card">Short Film 1 — (placeholder)</div>
            <div class="card">Short Film 2 — (placeholder)</div>
            <div class="card">Play: आप्पा — (scene gallery)</div>
          </div>
        </section>
      </div>
    ...
    <section class="about">
      <div style="flex:1">
        <h3>About</h3>
        <p>मी thefilmydj_ — कथा, भावना आणि visuals यांचं मिश्रण. माझं काम म्हणजे छोट्या गोष्टींना cinematic रूप देणं. Camera हातात आला की जग रंगात बदलतं — आणि तिथून सुरू होते एक नवी frame-by-frame सफर.</p>
      </div>
    ...
    <section id="contact">
      <h3>Contact</h3>
      <p>Direct: <a href="mailto:thefilmydj@example.com" style="color:inherit;text-decoration:underline">thefilmydj@example.com</a> — किंवा Instagram वर DM करा.</p>
    </section>

    <footer>
      © <span id="year"></span> thefilmydj_ — made by SD
    </footer>
  </div>
